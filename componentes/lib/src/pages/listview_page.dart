...
import 'package:flutter/material.dart';
 ...
 class _ListaPageState extends State<ListaPage> {
   ...
   ScrollController _scollController = new ScrollController();
  ...
  void initState() {
    ...
    _scollController.addListener((){
      //print('Scroll');
      if(_scollController.position.pixels == _scollController.position.maxScrollExtent){
        //_agregar10();
        fetchData();
      }
    });
  ...
  void dispose(){
   ...
   void respuestaHTTP(){
     ...
     _scollController.animateTo(
       _scollController.position.pixels + 100,
